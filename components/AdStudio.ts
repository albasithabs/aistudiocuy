...
export const AdStudio = {
    ...
    async handleGenerateAdConcept() {
        ...
        for (let i = 0; i < audiences.length; i++) {
            ...
            try {
                ...
                this.adStudioCampaigns.push({ audience, data: null as any });
            }
        }
        ...
        // Start generating images for the first active ad concept
    ...
    async handleGenerateSceneImage(index: number) {
        ...
        try {
            const prompt = `${scene.imagePrompt}. Final image must have an aspect ratio of ${this.aspectRatio}.`;
